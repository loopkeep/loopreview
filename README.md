...
| `d` | In the Conversation thread index only: delete the selected thread — its root delete flow (confirm with the comment count; a published root deletes from GitHub, your own only) |
